...
public class Tutorials_screen_five_Adapter extends RecyclerView.Adapter<Tutorials_screen_five_Adapter.HomeVH> {
    Context context;
    ArrayList<Integer> array_image = new ArrayList<Integer>();

    public Tutorials_screen_five_Adapter(Context context, List<Integer> array_image) {
