...
public final class ActivityConnectionsBinding implements ViewBinding {
  ...
  private ActivityConnectionsBinding(@NonNull CoordinatorLayout rootView,
      @NonNull CoordinatorLayout mainContainer, @NonNull TabLayout tabs,
  ...
  public static ActivityConnectionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityConnectionsBinding((CoordinatorLayout) rootView, mainContainer, tabs,
          viewPager);
    }
